...
const InvoiceList = React.lazy(() => import('./views/invoice-list/InvoiceList'))
const InvoiceListDetails = React.lazy(() => import('./views/invoice-list/InvoiceItemDetails'))
...
const routes = [
  ...
  { path: '/invoices', name: 'Invoice List', exact: true, component: InvoiceList },
  { path: '/invoices/items/', name: 'Items List', component: InvoiceListDetails },
